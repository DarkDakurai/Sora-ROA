...
set_window_value(AT_DTILT, 2, AG_WINDOW_GOTO, 30);
...
set_window_value(AT_DTILT, 5, AG_WINDOW_GOTO, 30);
...
set_window_value(AT_DTILT, 8, AG_WINDOW_GOTO, 30);

//master
set_window_value(AT_DTILT, 9, AG_WINDOW_LENGTH, 24);
set_window_value(AT_DTILT, 9, AG_WINDOW_ANIM_FRAMES, 11);
set_window_value(AT_DTILT, 9, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_DTILT, 9, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DTILT, 9, AG_WINDOW_SFX, sound_get("OB_swipeweak2"));
set_window_value(AT_DTILT, 9, AG_WINDOW_SFX_FRAME, 9);

set_window_value(AT_DTILT, 10, AG_WINDOW_LENGTH, 14);
set_window_value(AT_DTILT, 10, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_DTILT, 10, AG_WINDOW_ANIM_FRAME_START, 12);
set_window_value(AT_DTILT, 10, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DTILT, 10, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2"));
set_window_value(AT_DTILT, 10, AG_WINDOW_SFX_FRAME, 5);

set_window_value(AT_DTILT, 11, AG_WINDOW_LENGTH, 12);
set_window_value(AT_DTILT, 11, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_DTILT, 11, AG_WINDOW_ANIM_FRAME_START, 18);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, hfx[4]);
...
set_hitbox_value(AT_DTILT, 3, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_DTILT, 4, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_DTILT, 5, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_DTILT, 6, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_DTILT, 7, HG_VISUAL_EFFECT, hfx[0]);


//master
set_hitbox_value(AT_DTILT, 8, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_DTILT, 8, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DTILT, 8, HG_WINDOW, 9);
set_hitbox_value(AT_DTILT, 8, HG_WINDOW_CREATION_FRAME, 11);
set_hitbox_value(AT_DTILT, 8, HG_LIFETIME, 6);
set_hitbox_value(AT_DTILT, 8, HG_HITBOX_X, 54);
set_hitbox_value(AT_DTILT, 8, HG_HITBOX_Y, -15);
set_hitbox_value(AT_DTILT, 8, HG_WIDTH, 80);
set_hitbox_value(AT_DTILT, 8, HG_HEIGHT, 36);
set_hitbox_value(AT_DTILT, 8, HG_SHAPE, 2);
...
set_hitbox_value(AT_DTILT, 8, HG_VISUAL_EFFECT, hfx[8]);

set_hitbox_value(AT_DTILT, 9, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_DTILT, 9, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DTILT, 9, HG_WINDOW, 10);
set_hitbox_value(AT_DTILT, 9, HG_WINDOW_CREATION_FRAME, 7);
set_hitbox_value(AT_DTILT, 9, HG_LIFETIME, 3);
set_hitbox_value(AT_DTILT, 9, HG_HITBOX_X, 50);
set_hitbox_value(AT_DTILT, 9, HG_HITBOX_Y, -22);
set_hitbox_value(AT_DTILT, 9, HG_WIDTH, 80);
set_hitbox_value(AT_DTILT, 9, HG_HEIGHT, 54);
set_hitbox_value(AT_DTILT, 9, HG_PRIORITY, 1);
set_hitbox_value(AT_DTILT, 9, HG_SHAPE, 2);
set_hitbox_value(AT_DTILT, 9, HG_DAMAGE, 4);
set_hitbox_value(AT_DTILT, 9, HG_ANGLE, 50);
set_hitbox_value(AT_DTILT, 9, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_DTILT, 9, HG_KNOCKBACK_SCALING, .6);
set_hitbox_value(AT_DTILT, 9, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DTILT, 9, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_DTILT, 9, HG_HIT_SFX, sound_get("KB_hitmedium2"));
set_hitbox_value(AT_DTILT, 9, HG_VISUAL_EFFECT, hfx[0]);

set_hitbox_value(AT_DTILT, 10, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_DTILT, 10, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DTILT, 10, HG_WINDOW, 10);
set_hitbox_value(AT_DTILT, 10, HG_WINDOW_CREATION_FRAME, 10);
set_hitbox_value(AT_DTILT, 10, HG_LIFETIME, 2);
set_hitbox_value(AT_DTILT, 10, HG_HITBOX_X, 44);
set_hitbox_value(AT_DTILT, 10, HG_HITBOX_Y, -54);
set_hitbox_value(AT_DTILT, 10, HG_WIDTH, 55);
set_hitbox_value(AT_DTILT, 10, HG_HEIGHT, 80);
set_hitbox_value(AT_DTILT, 10, HG_PRIORITY, 1);
set_hitbox_value(AT_DTILT, 10, HG_DAMAGE, 4);
set_hitbox_value(AT_DTILT, 10, HG_ANGLE, 50);
set_hitbox_value(AT_DTILT, 10, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_DTILT, 10, HG_KNOCKBACK_SCALING, .6);
set_hitbox_value(AT_DTILT, 10, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DTILT, 10, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_DTILT, 10, HG_HIT_SFX, sound_get("KB_hitmedium2"));
set_hitbox_value(AT_DTILT, 10, HG_VISUAL_EFFECT, hfx[0]);
