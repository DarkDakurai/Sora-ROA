...
set_window_value(AT_DAIR, 2, AG_WINDOW_GOTO, 30);
...
set_window_value(AT_DAIR, 5, AG_WINDOW_GOTO, 30);
...
set_window_value(AT_DAIR, 6, AG_WINDOW_GOTO, 30);

//wisdom
set_window_value(AT_DAIR, 7, AG_WINDOW_LENGTH, 18);
set_window_value(AT_DAIR, 7, AG_WINDOW_ANIM_FRAMES, 8);
set_window_value(AT_DAIR, 7, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_DAIR, 7, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DAIR, 7, AG_WINDOW_SFX, asset_get("sfx_swipe_medium1"));
set_window_value(AT_DAIR, 7, AG_WINDOW_SFX_FRAME, 10);
...
set_window_value(AT_DAIR, 8, AG_WINDOW_GOTO, 30);
...
set_window_value(AT_DAIR, 9, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip1"));

set_window_value(AT_DAIR, 10, AG_WINDOW_LENGTH, 8);
set_window_value(AT_DAIR, 10, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_DAIR, 10, AG_WINDOW_ANIM_FRAME_START, 16);
set_window_value(AT_DAIR, 10, AG_WINDOW_HAS_WHIFFLAG, 1);
set_window_value(AT_DAIR, 10, AG_WINDOW_GOTO, 30);

//final
set_window_value(AT_DAIR, 11, AG_WINDOW_LENGTH, 9);
set_window_value(AT_DAIR, 11, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_DAIR, 11, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_DAIR, 11, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DAIR, 11, AG_WINDOW_SFX, sound_get("OB_swipemedium1"));
set_window_value(AT_DAIR, 11, AG_WINDOW_SFX_FRAME, 7);

set_window_value(AT_DAIR, 12, AG_WINDOW_LENGTH, 24);
set_window_value(AT_DAIR, 12, AG_WINDOW_ANIM_FRAMES, 8);
set_window_value(AT_DAIR, 12, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_DAIR, 12, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DAIR, 12, AG_WINDOW_SFX, sound_get("OK_swipemedium1"));
set_window_value(AT_DAIR, 12, AG_WINDOW_SFX_FRAME, 4);
set_window_value(AT_DAIR, 12, AG_WINDOW_VSPEED, -3);
set_window_value(AT_DAIR, 12, AG_WINDOW_VSPEED_TYPE, 2);

set_window_value(AT_DAIR, 13, AG_WINDOW_LENGTH, 6);
set_window_value(AT_DAIR, 13, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_DAIR, 13, AG_WINDOW_ANIM_FRAME_START, 12);
set_window_value(AT_DAIR, 13, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_DAIR, 7, HG_HEIGHT, 70);
...
set_hitbox_value(AT_DAIR, 7, HG_HITPAUSE_SCALING, .7);
...
set_hitbox_value(AT_DAIR, 8, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(AT_DAIR, 8, HG_LIFETIME, 5);
set_hitbox_value(AT_DAIR, 8, HG_HITBOX_X, 0);
set_hitbox_value(AT_DAIR, 8, HG_HITBOX_Y, 30);
set_hitbox_value(AT_DAIR, 8, HG_WIDTH, 40);
set_hitbox_value(AT_DAIR, 8, HG_HEIGHT, 70);
set_hitbox_value(AT_DAIR, 8, HG_PRIORITY, 5);
set_hitbox_value(AT_DAIR, 8, HG_DAMAGE, 7);
...
set_hitbox_value(AT_DAIR, 8, HG_KNOCKBACK_SCALING, 0.7);
set_hitbox_value(AT_DAIR, 8, HG_BASE_HITPAUSE, 15);
...
set_hitbox_value(AT_DAIR, 9, HG_WINDOW, 12);
set_hitbox_value(AT_DAIR, 9, HG_SHAPE, 2);
...
set_hitbox_value(AT_DAIR, 9, HG_HEIGHT, 50);
set_hitbox_value(AT_DAIR, 9, HG_PRIORITY, 2);
set_hitbox_value(AT_DAIR, 9, HG_DAMAGE, 5);
set_hitbox_value(AT_DAIR, 9, HG_ANGLE, 80);
set_hitbox_value(AT_DAIR, 9, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_DAIR, 9, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_DAIR, 9, HG_HIT_SFX,sound_get("OB_hitmedium2"));
set_hitbox_value(AT_DAIR, 9, HG_VISUAL_EFFECT, hfx[8]);

set_hitbox_value(AT_DAIR, 10, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_DAIR, 10, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DAIR, 10, HG_WINDOW, 12);
set_hitbox_value(AT_DAIR, 10, HG_WINDOW_CREATION_FRAME, 6);
set_hitbox_value(AT_DAIR, 10, HG_SHAPE, 2);
...
set_hitbox_value(AT_DAIR, 10, HG_WIDTH, 36);
set_hitbox_value(AT_DAIR, 10, HG_HEIGHT, 56);
set_hitbox_value(AT_DAIR, 10, HG_PRIORITY, 5);
...
set_hitbox_value(AT_DAIR, 10, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_DAIR, 10, HG_HIT_SFX, sound_get("OK_hitmedium1"));
set_hitbox_value(AT_DAIR, 10, HG_VISUAL_EFFECT, hfx[4]);

set_hitbox_value(AT_DAIR, 11, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_DAIR, 11, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DAIR, 11, HG_WINDOW, 12);
set_hitbox_value(AT_DAIR, 11, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_DAIR, 11, HG_SHAPE, 2);
set_hitbox_value(AT_DAIR, 11, HG_LIFETIME, 3);
set_hitbox_value(AT_DAIR, 11, HG_HITBOX_X, 2);
set_hitbox_value(AT_DAIR, 11, HG_HITBOX_Y, 20);
set_hitbox_value(AT_DAIR, 11, HG_WIDTH, 45);
set_hitbox_value(AT_DAIR, 11, HG_HEIGHT, 70);
set_hitbox_value(AT_DAIR, 11, HG_PRIORITY, 6);
set_hitbox_value(AT_DAIR, 11, HG_DAMAGE, 3);
...
set_hitbox_value(AT_DAIR, 11, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DAIR, 11, HG_HITPAUSE_SCALING, 0.4);
set_hitbox_value(AT_DAIR, 11, HG_HIT_SFX, sound_get("OK_hitheavy1"));
set_hitbox_value(AT_DAIR, 11, HG_VISUAL_EFFECT, hfx[4]);