...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("KB_hitmedium1"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("KB_hitmedium2"));
...
set_hitbox_value(AT_FSTRONG, 9, HG_ANGLE, 50);
set_hitbox_value(AT_FSTRONG, 9, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FSTRONG, 9, HG_KNOCKBACK_SCALING, 0.7);
