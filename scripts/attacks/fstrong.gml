...
set_window_value(AT_FSTRONG, 8, AG_WINDOW_GOTO, 20);
...
set_window_value(AT_FSTRONG, 11, AG_WINDOW_LENGTH, 4);
...
set_window_value(AT_FSTRONG, 12, AG_WINDOW_LENGTH, 15);
...
set_window_value(AT_FSTRONG, 12, AG_WINDOW_GOTO, 20);
