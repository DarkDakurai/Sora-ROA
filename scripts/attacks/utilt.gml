...
set_window_value(AT_UTILT, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
set_window_value(AT_UTILT, 5, AG_WINDOW_SFX_FRAME, 10);
...
set_hitbox_value(AT_UTILT, 6, HG_WINDOW_CREATION_FRAME, 12);
