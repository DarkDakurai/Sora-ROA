...
set_attack_value(AT_UTILT, AG_NUM_WINDOWS, 15);
...
set_window_value(AT_UTILT, 3, AG_WINDOW_GOTO, 30);
...
set_window_value(AT_UTILT, 6, AG_WINDOW_GOTO, 30);
...
set_window_value(AT_UTILT, 8, AG_WINDOW_LENGTH, 22);
set_window_value(AT_UTILT, 8, AG_WINDOW_ANIM_FRAMES, 10);
...
set_window_value(AT_UTILT, 8, AG_WINDOW_SFX_FRAME, 16);

set_window_value(AT_UTILT, 9, AG_WINDOW_LENGTH, 12);
set_window_value(AT_UTILT, 9, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_UTILT, 9, AG_WINDOW_ANIM_FRAME_START, 16);
set_window_value(AT_UTILT, 9, AG_WINDOW_HAS_WHIFFLAG, 1);
set_window_value(AT_UTILT, 9, AG_WINDOW_GOTO, 30);

//master
set_window_value(AT_UTILT, 10, AG_WINDOW_LENGTH, 10);
set_window_value(AT_UTILT, 10, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_UTILT, 10, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_UTILT, 10, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 10, AG_WINDOW_SFX, sound_get("KB_swipeweak2"));
set_window_value(AT_UTILT, 10, AG_WINDOW_SFX_FRAME, 8);

set_window_value(AT_UTILT, 11, AG_WINDOW_LENGTH, 15);
set_window_value(AT_UTILT, 11, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_UTILT, 11, AG_WINDOW_ANIM_FRAME_START, 5);
set_window_value(AT_UTILT, 11, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 11, AG_WINDOW_SFX, sound_get("OB_swipeweak1"));
set_window_value(AT_UTILT, 11, AG_WINDOW_SFX_FRAME, 7);

set_window_value(AT_UTILT, 12, AG_WINDOW_LENGTH, 8);
set_window_value(AT_UTILT, 12, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_UTILT, 12, AG_WINDOW_ANIM_FRAME_START, 10);
set_window_value(AT_UTILT, 12, AG_WINDOW_HAS_WHIFFLAG, 1);
set_window_value(AT_UTILT, 12, AG_WINDOW_GOTO, 30);

//final
set_window_value(AT_UTILT, 13, AG_WINDOW_LENGTH, 11);
set_window_value(AT_UTILT, 13, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_UTILT, 13, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_UTILT, 13, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 13, AG_WINDOW_SFX, sound_get("OB_swipemedium1"));
set_window_value(AT_UTILT, 13, AG_WINDOW_SFX_FRAME, 9);

set_window_value(AT_UTILT, 14, AG_WINDOW_LENGTH, 20);
set_window_value(AT_UTILT, 14, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_UTILT, 14, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_UTILT, 14, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 14, AG_WINDOW_SFX, sound_get("OK_swipemedium1"));
set_window_value(AT_UTILT, 14, AG_WINDOW_SFX_FRAME, 8);

set_window_value(AT_UTILT, 15, AG_WINDOW_LENGTH, 17);
set_window_value(AT_UTILT, 15, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_UTILT, 15, AG_WINDOW_ANIM_FRAME_START, 10);
set_window_value(AT_UTILT, 15, AG_WINDOW_HAS_WHIFFLAG, 1);


set_num_hitboxes(AT_UTILT, 19);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, hfx[4]);
...
set_hitbox_value(AT_UTILT, 4, HG_VISUAL_EFFECT, hfx[4]);
...
set_hitbox_value(AT_UTILT, 5, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 6, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 7, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 8, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 9, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 10, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 11, HG_VISUAL_EFFECT, hfx[0]);
...
set_hitbox_value(AT_UTILT, 12, HG_WINDOW_CREATION_FRAME, 18);
...
//master
set_hitbox_value(AT_UTILT, 13, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_UTILT, 13, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 13, HG_WINDOW, 11);
set_hitbox_value(AT_UTILT, 13, HG_LIFETIME, 3);
set_hitbox_value(AT_UTILT, 13, HG_HITBOX_X, 20);
set_hitbox_value(AT_UTILT, 13, HG_HITBOX_Y, -56);
set_hitbox_value(AT_UTILT, 13, HG_WIDTH, 70);
set_hitbox_value(AT_UTILT, 13, HG_HEIGHT, 99);
set_hitbox_value(AT_UTILT, 13, HG_PRIORITY, 6);
set_hitbox_value(AT_UTILT, 13, HG_DAMAGE, 7);
set_hitbox_value(AT_UTILT, 13, HG_ANGLE, 70);
set_hitbox_value(AT_UTILT, 13, HG_ANGLE_FLIPPER, 7);
set_hitbox_value(AT_UTILT, 13, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UTILT, 13, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 13, HG_VISUAL_EFFECT, hfx[0]);
set_hitbox_value(AT_UTILT, 13, HG_HIT_SFX, sound_get("KB_hitmedium1"));

set_hitbox_value(AT_UTILT, 14, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_UTILT, 14, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 14, HG_WINDOW, 11);
set_hitbox_value(AT_UTILT, 14, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(AT_UTILT, 14, HG_LIFETIME, 3);
set_hitbox_value(AT_UTILT, 14, HG_HITBOX_X, -30);
set_hitbox_value(AT_UTILT, 14, HG_HITBOX_Y, -50);
set_hitbox_value(AT_UTILT, 14, HG_WIDTH, 70);
set_hitbox_value(AT_UTILT, 14, HG_HEIGHT, 70);
set_hitbox_value(AT_UTILT, 14, HG_PRIORITY, 6);
set_hitbox_value(AT_UTILT, 14, HG_DAMAGE, 7);
set_hitbox_value(AT_UTILT, 14, HG_ANGLE, 70);
set_hitbox_value(AT_UTILT, 14, HG_ANGLE_FLIPPER, 7);
set_hitbox_value(AT_UTILT, 14, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UTILT, 14, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 14, HG_VISUAL_EFFECT, hfx[0]);
set_hitbox_value(AT_UTILT, 14, HG_HIT_SFX, sound_get("KB_hitmedium1"));

set_hitbox_value(AT_UTILT, 15, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_UTILT, 15, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 15, HG_WINDOW, 11);
set_hitbox_value(AT_UTILT, 15, HG_WINDOW_CREATION_FRAME, 9);
set_hitbox_value(AT_UTILT, 15, HG_LIFETIME, 3);
set_hitbox_value(AT_UTILT, 15, HG_HITBOX_X, 0);
set_hitbox_value(AT_UTILT, 15, HG_HITBOX_Y, -66);
set_hitbox_value(AT_UTILT, 15, HG_WIDTH, 100);
set_hitbox_value(AT_UTILT, 15, HG_HEIGHT, 60);
set_hitbox_value(AT_UTILT, 15, HG_PRIORITY, 1);
set_hitbox_value(AT_UTILT, 15, HG_DAMAGE, 3);
set_hitbox_value(AT_UTILT, 15, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 15, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UTILT, 15, HG_KNOCKBACK_SCALING, 0.6);
set_hitbox_value(AT_UTILT, 15, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 15, HG_HITPAUSE_SCALING, 0.5);
set_hitbox_value(AT_UTILT, 15, HG_VISUAL_EFFECT, hfx[8]);
set_hitbox_value(AT_UTILT, 15, HG_HIT_SFX, sound_get("OB_hitmedium2"));

//final
set_hitbox_value(AT_UTILT, 16, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 16, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_UTILT, 16, HG_WINDOW, 14);
set_hitbox_value(AT_UTILT, 16, HG_LIFETIME, 4);
set_hitbox_value(AT_UTILT, 16, HG_HITBOX_X, 20);
set_hitbox_value(AT_UTILT, 16, HG_HITBOX_Y, -80);
set_hitbox_value(AT_UTILT, 16, HG_WIDTH, 80);
set_hitbox_value(AT_UTILT, 16, HG_HEIGHT, 100);
set_hitbox_value(AT_UTILT, 16, HG_PRIORITY, 6);
set_hitbox_value(AT_UTILT, 16, HG_DAMAGE, 4);
set_hitbox_value(AT_UTILT, 16, HG_ANGLE, 105);
set_hitbox_value(AT_UTILT, 16, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UTILT, 16, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 16, HG_VISUAL_EFFECT, hfx[8]);
set_hitbox_value(AT_UTILT, 16, HG_HIT_SFX, sound_get("OB_hitmedium1"));

set_hitbox_value(AT_UTILT, 17, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 17, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_UTILT, 17, HG_WINDOW, 14);
set_hitbox_value(AT_UTILT, 17, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_UTILT, 17, HG_LIFETIME, 3);
set_hitbox_value(AT_UTILT, 17, HG_HITBOX_X, -30);
set_hitbox_value(AT_UTILT, 17, HG_HITBOX_Y, -95);
set_hitbox_value(AT_UTILT, 17, HG_WIDTH, 100);
set_hitbox_value(AT_UTILT, 17, HG_HEIGHT, 70);
set_hitbox_value(AT_UTILT, 17, HG_PRIORITY, 6);
set_hitbox_value(AT_UTILT, 17, HG_DAMAGE, 4);
set_hitbox_value(AT_UTILT, 17, HG_ANGLE, 75);
set_hitbox_value(AT_UTILT, 17, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UTILT, 17, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UTILT, 17, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 17, HG_VISUAL_EFFECT, hfx[8]);
set_hitbox_value(AT_UTILT, 17, HG_HIT_SFX, sound_get("OB_hitmedium1"));

set_hitbox_value(AT_UTILT, 18, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 18, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_UTILT, 18, HG_WINDOW, 14);
set_hitbox_value(AT_UTILT, 18, HG_WINDOW_CREATION_FRAME, 10);
set_hitbox_value(AT_UTILT, 18, HG_LIFETIME, 4);
set_hitbox_value(AT_UTILT, 18, HG_HITBOX_X, 35);
set_hitbox_value(AT_UTILT, 18, HG_HITBOX_Y, -90);
set_hitbox_value(AT_UTILT, 18, HG_WIDTH, 80);
set_hitbox_value(AT_UTILT, 18, HG_HEIGHT, 100);
set_hitbox_value(AT_UTILT, 18, HG_PRIORITY, 1);
set_hitbox_value(AT_UTILT, 18, HG_DAMAGE, 5);
set_hitbox_value(AT_UTILT, 18, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 18, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UTILT, 18, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(AT_UTILT, 18, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_UTILT, 18, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(AT_UTILT, 18, HG_VISUAL_EFFECT, hfx[4]);
set_hitbox_value(AT_UTILT, 18, HG_HIT_SFX, sound_get("OK_hitmedium2"));

set_hitbox_value(AT_UTILT, 19, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 19, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_UTILT, 19, HG_WINDOW, 14);
set_hitbox_value(AT_UTILT, 19, HG_WINDOW_CREATION_FRAME, 14);
set_hitbox_value(AT_UTILT, 19, HG_LIFETIME, 3);
set_hitbox_value(AT_UTILT, 19, HG_HITBOX_X, -45);
set_hitbox_value(AT_UTILT, 19, HG_HITBOX_Y, -80);
set_hitbox_value(AT_UTILT, 19, HG_WIDTH, 80);
set_hitbox_value(AT_UTILT, 19, HG_HEIGHT, 80);
set_hitbox_value(AT_UTILT, 19, HG_PRIORITY, 1);
set_hitbox_value(AT_UTILT, 19, HG_DAMAGE, 5);
set_hitbox_value(AT_UTILT, 19, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 19, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UTILT, 19, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(AT_UTILT, 19, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_UTILT, 19, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(AT_UTILT, 19, HG_VISUAL_EFFECT, hfx[4]);
set_hitbox_value(AT_UTILT, 19, HG_HIT_SFX, sound_get("OK_hitmedium2"));