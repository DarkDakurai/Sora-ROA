...
if "blade_alt" in self{
    if form && form != 2{
        ...
        set_article_color_slot(5, sora_alt[0][get_player_color(player)][5][0], sora_alt[0][get_player_color(player)][5][1], sora_alt[0][get_player_color(player)][5][2]);
        set_article_color_slot(6, sora_alt[0][get_player_color(player)][6][0], sora_alt[0][get_player_color(player)][6][1], sora_alt[0][get_player_color(player)][6][2]);
    }
}